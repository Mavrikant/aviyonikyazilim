...
Tersine mühendislik, mevcut koddan gereksinim ve tasarım bilgisini yeniden kurma
çalışmasıdır. Eski veya eksik dokümantasyona sahip sistemlerde sıkça başvurulur.
...
- Tersine mühendislik, bilgi kurtarma işidir.
- Çıkarılan bilgi doğrulanmadan kabul edilmemelidir.
- Koddan elde edilen taslak, yeni doğrulama gerektirir.
